...
import com.fstt.cours.ecommerce.view.ProductView;
...
//                startActivity(intent);
    ...
    {
        super.onStart();
        LinearLayout listProducts=findViewById(R.id.listProducts);

        for(int i=0;i<5;i++){
            View product = LayoutInflater.from(this).inflate(R.layout.products_layout, null);
            ProductView holder=new ProductView(product);
            holder.txtProductName.setText("produit "+i);
            holder.txtProductDescription.setText("This product is a stylish and practical addition to any household. ");
            holder.txtProductPrice.setText(""+15*(i+10));
